...
router.get("/init", async (req, res, next) => {
  var Pizzas = [
    ...
    { description: "С привкусом незакрытой сессии и выдохшегося пива", name: "Студенческая", price: 380, picture: "https://cheetay-prod-media.s3.amazonaws.com/production/media/images/partners/2020/03/Buy_Pizza_Online_Cheetay.pk_QEQfOPK.PNG", sostav: "Тесто, чесночный соус, акционные сосиски, грибы, сыр, маслины", additionals: [3, 4, 5] },
